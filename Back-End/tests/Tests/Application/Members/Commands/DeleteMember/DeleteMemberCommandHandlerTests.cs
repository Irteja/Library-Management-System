...
namespace LibraryManagementSystem.Tests.Application.Members.Commands.DeleteMember
{
    public class DeleteMemberCommandHandlerTests
    {
        ...
        public DeleteMemberCommandHandlerTests()
        {
            ...
            _handler = new DeleteMemberCommandHandler(_contextMock.Object);
        }
        ...
        [Fact]
        public async Task Handle_ShouldDeleteMember_WhenValid()
        {
            ...
            _contextMock.Setup(c => c.Remove(It.IsAny<Member>()));
            _contextMock.Setup(c => c.SaveChangesAsync(It.IsAny<CancellationToken>())).ReturnsAsync(1);

            await _handler.Handle(command, CancellationToken.None);

            _contextMock.Verify(c => c.Remove(member), Times.Once);
        }
